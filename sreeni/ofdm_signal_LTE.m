...
%   ---------------------------------------------
%   B:  %   +++++  AWGN CHANNEL    +++++ to create the noise channel
%   ---------------------------------------------
snr=10;%signal to noise ratio
ynoisy = awgn(ofdm_signal,snr,'measured');%awgn channel
figure(5);
...
scatterplot(recvd_serial_data);title('qpsk modulated received data')
